...
public class UsuarioService {
    ...
    public UsuarioService(UsuarioRepository usuarioRepository, PasswordEncoder passwordEncoder, JwtService jwtService, SessaoRepository sessaoRepository,  EmailService emailService) {
